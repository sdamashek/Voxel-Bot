...
def getCountThingy():
    ...
    y = "http://en.wikipedia.org/w/api.php?action=query&list=recentchanges&rcstart="+otherCurrentTime+"&rclimit=500&rcdir=older&rcprop=comment&format=xml" #Define RecentChanges Query
